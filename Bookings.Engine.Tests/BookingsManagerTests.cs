...
namespace Bookings.Engine.Tests
{
    public class BookingsManagerTests
    {
        ...
        {
            //Test
            var timeSlots = mgr.GetTimeSlots(DateTime.Today.AddDays(1), "kjlskdjf", TimeSpan.FromMinutes(30)).ToList();
        ...
        {
            var timeSlots = mgr.GetTimeSlots(DateTime.Today.AddDays(2), "kjlskdjf", TimeSpan.FromMinutes(30)).ToList();
        ...
        {
            var dates = mgr.GetAvailableDates(DateTime.Today, DateTime.Today.AddDays(5), "kjlskdjf", TimeSpan.FromMinutes(30)).ToList();
